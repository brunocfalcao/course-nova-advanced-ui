...
<head>
    ...
    <style type="text/css">
        .bg-hero {
            {{--background-image: url('{{ Vite::asset('course::resources/images/background.svg') }}');--}}
        }
    </style>
</head>
...
{{--                        <img class="h-8 w-auto" src="{{ Vite::asset('resources/vendor/course-nova-advanced-ui/assets/images/logo.png') }}" />--}}
...
{{--                        <img class="h-8 w-auto" src="{{  Vite::asset('resources/assets/images/logo.png') }}" />--}}
        ...
        <x-masteringnova::coupon-discount />
                ...
                <div class="{{ TW::default('space-y-6 w-full')->xl('w-1/2')->css() }}">
                    ...
                    <div class="space-y-9">
                        ...
                        <div class="hidden flex-stop-wrap-at-lg xl:block xl:space-x-5">
                            <x-eduka::button-primary color="aquacyan" width="w-auto" target="_blank" href="https://www.publico.pt">
                                <x-slot:svg>
                            ...
                            <x-eduka::button-secondary color="bombay" width="w-auto" target="_blank" href="https://www.publico.pt">
                                <x-slot:svg>
                                    <svg aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            ...
                            @unlesssubscribedToNewsletter()
                            <x-masteringnova::subscribe-to-newsletter />
                            @endsubscribedToNewsletter

                            <x-masteringnova::subscribe-to-newsletter-notification />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-2/5 bg-bombay-100 relative h-64 overflow-hidden rounded-xl mx-auto">
                        ...
                        <div id="testimonial-item-1" class="hidden duration-700 ease-in-out">
                            <div class="py-9 px-6">
                                ...
                                <div class="flex flex-col px-8 gap-y-1 pt-6 text-md font-bold">
                                    <p>Mohamed Said</p>
                                    <p class="text-sm text-bombay-500">Laravel Nova Team member</p>
                                </div>
                            </div>
                        </div>
                        <div id="testimonial-item-2" class="hidden duration-700 ease-in-out">
                            <div class="py-9 px-6">
                                ...
                                <div class="flex flex-col px-8 gap-y-1 pt-6 text-md font-bold">
                                    <p>Taylor Otwell</p>
                                    <p class="text-sm text-bombay-500">Creator of Laravel</p>
                                </div>
                            </div>
                        </div>
                        <div id="testimonial-item-3" class="hidden duration-700 ease-in-out">
                            <div class="py-9 px-6">
                                ...
                                <div class="flex flex-col px-8 gap-y-1 pt-6 text-md font-bold">
                                    <p>David Hemphill</p>
                                    <p class="text-sm text-bombay-500">Co-Creator of Laravel</p>
                                </div>
                            </div>
                        </div>
                        <div id="testimonial-item-4" class="hidden duration-700 ease-in-out">
                            <div class="py-9 px-6">
                                ...
                                <div class="flex flex-col px-8 gap-y-1 pt-6 text-md font-bold">
                                    <p>Nuno Maduro</p>
                                    <p class="text-sm text-bombay-500">Laravel Core Team member</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
{{--                        <img class="h-16 rounded-full w-auto mx-auto" src="{{  Vite::asset('resources/assets/images/nuno-maduro.jpg') }}">--}}
        ...
        <x-masteringnova::single-testimonial />

        <x-masteringnova::testimonials />

        <x-masteringnova::course />

        <x-masteringnova::faqs />
